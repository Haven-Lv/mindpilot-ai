...
## 🙏 特别致谢
本项目架构、核心逻辑灵感与底层实现，完全来源于开源项目：[ \[原Nanobot项目完整仓库地址\]](https://github.com/HKUDS/nanobot)

感谢原作者的优秀开源贡献，为本项目提供了强大的Agent运行框架、会话管理、LLM工具调用等整套成熟设计。

原始代码遵循 [MIT/对应开源协议] 许可，原始版权归原作者所有。
本项目仅在此基础上进行业务改造、体验优化与功能拓展。